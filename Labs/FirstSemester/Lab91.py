...
n30 = np.array([[3, 4, 2, 3], [5, 6, 4, 4], [7, 8, 5, 6]], dtype=float)
n45 = np.array([[5, 5, 5, 5, 5], [10, 8, 8, 8, 7], [13, 12, 11, 11, 11]], dtype=float)
n60 = np.array([[5, 6, 6, 6], [8, 10, 10, 10], [12, 14, 14, 14]], dtype=float)
